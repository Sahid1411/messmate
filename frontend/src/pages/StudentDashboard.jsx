...
const StudentDashboard = () => {
    ...
    const fetchInitialData = async () => { 
        ...
        try {
            const [hRes, sRes, aRes, appRes] = await Promise.all([
                axios.get('https://messmate-backend.onrender.com/api/payment/my-history', config),
                axios.get('https://messmate-backend.onrender.com/api/settings'),
                axios.get('https://messmate-backend.onrender.com/api/mess/attendance/my', config),
                axios.get('https://messmate-backend.onrender.com/api/mess/applications/my', config)
            ]);
    ...
    e.preventDefault();
    try {
        const { data } = await axios.put('https://messmate-backend.onrender.com/api/auth/update-profile', profileForm, config);
    ...
    const handlePay = async (month) => {
        setLoading(true);
        try {
            const { data } = await axios.post('https://messmate-backend.onrender.com/api/payment/create-order', { month }, config);
            const options = {
                key: data.key_id,
                ...
                handler: async (response) => {
                    await axios.post('https://messmate-backend.onrender.com/api/payment/verify-payment', {
    ...
    const handleAppSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post('https://messmate-backend.onrender.com/api/mess/apply', appForm, config);
