...
const Register = () => {
    const [formData, setFormData] = useState({ name: '', email: '', password: '', role: 'student', dept: '', roomNo: '', rollNo: '' });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Show specific error from backend (e.g., "Admin already exists")
                        ...
                        <div className="card-body p-4">
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-3">
                                    ...
                                    {formData.role === 'admin' && <small className="text-danger">Note: Only one admin account is allowed in the system.</small>}
                                </div>
                                    ...
                                    <>
                                        <div className="row">
                                            <div className="col-md-6 mb-3">
                                                ...
                                                <input className="form-control" onChange={e => setFormData({...formData, dept: e.target.value})} required />
                                            </div>
                                            <div className="col-md-6 mb-3">
                                                <label className="form-label">Roll Number</label>
                                                <input className="form-control" onChange={e => setFormData({...formData, rollNo: e.target.value})} required />
                                            </div>
                                        </div>
                                        <div className="mb-3">
                                            <label className="form-label">Room Number</label>
                                            <input className="form-control" onChange={e => setFormData({...formData, roomNo: e.target.value})} required />
                                        </div>
                                    </>
                                )}
