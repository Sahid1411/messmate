...
const AdminDashboard = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const [payRes, studRes, setRes, appRes] = await Promise.all([
                axios.get('https://messmate-backend-kj4h.onrender.com/api/payment/all', config),
                axios.get('https://messmate-backend-kj4h.onrender.com/api/auth/students', config),
                axios.get('https://messmate-backend-kj4h.onrender.com/api/settings'),
                axios.get('https://messmate-backend-kj4h.onrender.com/api/mess/applications', config)
            ]);
    ...
    const fetchAttendance = async () => {
        try {
            const { data } = await axios.get(`https://messmate-backend-kj4h.onrender.com/api/mess/attendance?date=${attendanceDate}`, config);
    ...
    const handleMarkAttendance = async (studentId, mealType) => {
        try {
            await axios.post('https://messmate-backend-kj4h.onrender.com/api/mess/attendance/mark', {
                studentId,
                date: attendanceDate,
                mealType
            }, config);
    ...
    const handleAppReply = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`https://messmate-backend-kj4h.onrender.com/api/mess/applications/${replyData.id}`, {
    ...
    const handleSaveSettings = async (e) => {
        ...
        try {
            const { data } = await axios.put(
                'https://messmate-backend-kj4h.onrender.com/api/settings', 
    ...
    const handleConfirmCashPayment = async (e) => {
        e.preventDefault();
        try {
            await axios.post('https://messmate-backend-kj4h.onrender.com/api/payment/record-cash', { 
    ...
    const handleApprove = async (id) => {
        try {
            await axios.put(`https://messmate-backend-kj4h.onrender.com/api/payment/approve/${id}`, {}, config);
    ...
    const handleReject = async (id) => {
        if(window.confirm("Reject and remove this payment request?")) {
            try {
                await axios.delete(`https://messmate-backend-kj4h.onrender.com/api/payment/reject/${id}`, config);
    ...
    const defaulters = students.filter(student => {
        ...
        const handleFinalDelete = async () => {
            try {
                await axios.delete(`https://messmate-backend-kj4h.onrender.com/api/auth/student/${deleteModal.id}`, config);
